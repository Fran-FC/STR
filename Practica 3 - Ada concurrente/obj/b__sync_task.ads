...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_sync_task" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#929b9250#;
   pragma Export (C, u00001, "sync_taskB");
   ...
   u00054 : constant Version_32 := 16#87cd2ab9#;
   pragma Export (C, u00054, "ada__calendar__delaysB");
   u00055 : constant Version_32 := 16#b27fb9e9#;
   pragma Export (C, u00055, "ada__calendar__delaysS");
   u00056 : constant Version_32 := 16#ee80728a#;
   pragma Export (C, u00056, "system__tracesB");
   u00057 : constant Version_32 := 16#b42884ae#;
   pragma Export (C, u00057, "system__tracesS");
   u00058 : constant Version_32 := 16#402b6a67#;
   pragma Export (C, u00058, "ada__real_timeB");
   u00059 : constant Version_32 := 16#c3d451b0#;
   pragma Export (C, u00059, "ada__real_timeS");
   u00060 : constant Version_32 := 16#888154ba#;
   pragma Export (C, u00060, "system__taskingB");
   u00061 : constant Version_32 := 16#c03b1874#;
   pragma Export (C, u00061, "system__taskingS");
   u00062 : constant Version_32 := 16#08881467#;
   pragma Export (C, u00062, "system__task_primitivesS");
   u00063 : constant Version_32 := 16#decff30d#;
   pragma Export (C, u00063, "system__os_interfaceB");
   u00064 : constant Version_32 := 16#dac51a48#;
   pragma Export (C, u00064, "system__os_interfaceS");
   u00065 : constant Version_32 := 16#3dce974e#;
   pragma Export (C, u00065, "system__linuxS");
   u00066 : constant Version_32 := 16#69418a44#;
   pragma Export (C, u00066, "system__os_constantsS");
   u00067 : constant Version_32 := 16#72b39087#;
   pragma Export (C, u00067, "system__unsigned_typesS");
   u00068 : constant Version_32 := 16#35461298#;
   pragma Export (C, u00068, "system__task_primitives__operationsB");
   u00069 : constant Version_32 := 16#28930186#;
   pragma Export (C, u00069, "system__task_primitives__operationsS");
   u00070 : constant Version_32 := 16#e95cd909#;
   pragma Export (C, u00070, "system__bit_opsB");
   u00071 : constant Version_32 := 16#0765e3a3#;
   pragma Export (C, u00071, "system__bit_opsS");
   u00072 : constant Version_32 := 16#66645a25#;
   pragma Export (C, u00072, "system__interrupt_managementB");
   u00073 : constant Version_32 := 16#f8b85fd3#;
   ...
   u00075 : constant Version_32 := 16#7e997377#;
   pragma Export (C, u00075, "system__multiprocessorsS");
   u00076 : constant Version_32 := 16#375a3ef7#;
   pragma Export (C, u00076, "system__task_infoB");
   u00077 : constant Version_32 := 16#c01cd21c#;
   pragma Export (C, u00077, "system__task_infoS");
   u00078 : constant Version_32 := 16#58108132#;
   pragma Export (C, u00078, "system__tasking__debugB");
   u00079 : constant Version_32 := 16#72bfd9bc#;
   ...
   u00081 : constant Version_32 := 16#44953bd4#;
   pragma Export (C, u00081, "system__concat_2S");
   u00082 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00082, "system__concat_3B");
   u00083 : constant Version_32 := 16#4d45b0a1#;
   pragma Export (C, u00083, "system__concat_3S");
   u00084 : constant Version_32 := 16#36a43a0a#;
   pragma Export (C, u00084, "system__crtlS");
   u00085 : constant Version_32 := 16#18e0e51c#;
   pragma Export (C, u00085, "system__img_enum_newB");
   u00086 : constant Version_32 := 16#2779eac4#;
   pragma Export (C, u00086, "system__img_enum_newS");
   u00087 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00087, "system__img_lliB");
   u00088 : constant Version_32 := 16#577ab9d5#;
   pragma Export (C, u00088, "system__img_lliS");
   u00089 : constant Version_32 := 16#118e865d#;
   pragma Export (C, u00089, "system__stack_usageB");
   u00090 : constant Version_32 := 16#3a3ac346#;
   ...
   u00112 : constant Version_32 := 16#4db84b5a#;
   ...
   u00122 : constant Version_32 := 16#40fbb80f#;
   pragma Export (C, u00122, "system__tasking__rendezvousB");
   u00123 : constant Version_32 := 16#ea18a31e#;
   pragma Export (C, u00123, "system__tasking__rendezvousS");
   u00124 : constant Version_32 := 16#100eaf58#;
   pragma Export (C, u00124, "system__restrictionsB");
   u00125 : constant Version_32 := 16#aab42239#;
   pragma Export (C, u00125, "system__restrictionsS");
   u00126 : constant Version_32 := 16#d8038a64#;
   pragma Export (C, u00126, "system__tasking__entry_callsB");
   u00127 : constant Version_32 := 16#df420580#;
   pragma Export (C, u00127, "system__tasking__entry_callsS");
   u00128 : constant Version_32 := 16#c5fb5685#;
   pragma Export (C, u00128, "system__tasking__initializationB");
   u00129 : constant Version_32 := 16#efd25374#;
   pragma Export (C, u00129, "system__tasking__initializationS");
   u00130 : constant Version_32 := 16#312b97cd#;
   pragma Export (C, u00130, "system__soft_links__taskingB");
   u00131 : constant Version_32 := 16#5ae92880#;
   pragma Export (C, u00131, "system__soft_links__taskingS");
   u00132 : constant Version_32 := 16#17d21067#;
   pragma Export (C, u00132, "ada__exceptions__is_null_occurrenceB");
   u00133 : constant Version_32 := 16#e1d7566f#;
   pragma Export (C, u00133, "ada__exceptions__is_null_occurrenceS");
   u00134 : constant Version_32 := 16#a4a31ee6#;
   pragma Export (C, u00134, "system__tasking__task_attributesB");
   u00135 : constant Version_32 := 16#6bc95a13#;
   pragma Export (C, u00135, "system__tasking__task_attributesS");
   u00136 : constant Version_32 := 16#c8081f14#;
   pragma Export (C, u00136, "system__tasking__protected_objectsB");
   u00137 : constant Version_32 := 16#a9001c61#;
   pragma Export (C, u00137, "system__tasking__protected_objectsS");
   u00138 : constant Version_32 := 16#547d8eae#;
   pragma Export (C, u00138, "system__tasking__protected_objects__entriesB");
   u00139 : constant Version_32 := 16#427cf21f#;
   pragma Export (C, u00139, "system__tasking__protected_objects__entriesS");
   u00140 : constant Version_32 := 16#5e1f99be#;
   pragma Export (C, u00140, "system__tasking__protected_objects__operationsB");
   u00141 : constant Version_32 := 16#ba36ad85#;
   pragma Export (C, u00141, "system__tasking__protected_objects__operationsS");
   u00142 : constant Version_32 := 16#e8f87c58#;
   pragma Export (C, u00142, "system__tasking__queuingB");
   u00143 : constant Version_32 := 16#d1ba2fcb#;
   pragma Export (C, u00143, "system__tasking__queuingS");
   u00144 : constant Version_32 := 16#bad2cea3#;
   pragma Export (C, u00144, "system__tasking__utilitiesB");
   u00145 : constant Version_32 := 16#9b15eab5#;
   pragma Export (C, u00145, "system__tasking__utilitiesS");
   u00146 : constant Version_32 := 16#bd6fc52e#;
   pragma Export (C, u00146, "system__traces__taskingB");
   u00147 : constant Version_32 := 16#09f07b39#;
   pragma Export (C, u00147, "system__traces__taskingS");
   u00148 : constant Version_32 := 16#149dbb7c#;
   pragma Export (C, u00148, "system__tasking__stagesB");
   u00149 : constant Version_32 := 16#a2ee1060#;
   pragma Export (C, u00149, "system__tasking__stagesS");
   u00150 : constant Version_32 := 16#a6359005#;
   pragma Export (C, u00150, "system__memoryB");
   u00151 : constant Version_32 := 16#1f488a30#;
