pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b__gas_1.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__gas_1.adb");
...
package body ada_main is
   ...
   E108 : Short_Integer; pragma Import (Ada, E108, "consola_compartida_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "consola_compartida__finalize_spec");
      begin
         F1;
      end;
      E163 := E163 - 1;
   ...
   begin
      ...
      E173 := E173 + 1;
      Consola_Compartida'Elab_Spec;
      E108 := E108 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_gas_1");
...
--  BEGIN Object file/option list
   --   /home/francesc/Documents/STR/Practica 4/obj/consola_compartida.o
   --   /home/francesc/Documents/STR/Practica 4/obj/gas_1.o
   --   -L/home/francesc/Documents/STR/Practica 4/obj/
   --   -L/home/francesc/Documents/STR/Practica 4/obj/
